...
const OrdersPageContent = () => {
  ...
  const handleDeleteOrder = async (orderIdToDelete: string) => {
    try {
      ...
      const result = await deleteOrder(orderIdToDelete);
    ...
    <Container className="py-8">
      ...
      >
        <AlertDialogContent className="sm:max-w-md">
          <AlertDialogHeader>
            <div className="mx-auto mb-4 w-16 h-16 bg-babyshopSky/10 rounded-full flex items-center justify-center">
            ...
            <AlertDialogDescription className="text-center">
              ...
              securely.
              <div className="mt-4 p-4 bg-babyshopSky/5 rounded-lg">
                <div className="flex justify-between items-center text-sm mb-2">
                  <span className="text-gray-600">Order Total:</span>
                  <span className="font-semibold text-babyshopBlack">
                    <PriceFormatter amount={orderToPay?.total || 0} />
                  </span>
                </div>
          ...
          <AlertDialogFooter className="sm:flex-col sm:space-x-0 gap-2">
            ...
            <AlertDialogAction
              ...
              className="w-full sm:w-full bg-babyshopSky hover:bg-babyshopSky/90 text-white"
            >
              {processingPayment ? (
                <>
