...
const ProfilePage = () => {
  ...
  const onPasswordSubmit = async (data: PasswordFormData) => {
    ...
    try {
      toast.error("Password change not supported", {
        description:
          "Please update your password through your sign-in provider.",
        className: "bg-red-50 text-gray-800 border-red-200",
        duration: 7000,
      });
    } catch (error) {
          ...
          editingAddress={
            editingAddress
              ? {
                  ...
                  defaulte: editingAddress.defaulte ?? false,
                }
              : null
          }
