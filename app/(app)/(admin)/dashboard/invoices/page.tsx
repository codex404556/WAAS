...
const InvoicePage: React.FC = () => {
  ...
  const fetchOrders = useCallback(async () => {
    try {
      ...
      const response = await payloadFetch<{
        docs?: Order[];
      }>(`/api/admin/orders?limit=${perPage}&sort=-createdAt&depth=2`);
          ...
          <div class="invoice">
            <div class="header">
              <div class="company-info">
                <h1>BabyShop</h1>
                <p>123 Business St<br>City, State 12345<br>contact@babyshop.com</p>
              </div>
  ...
  const shareInvoice = (platform: string) => {
    ...
    } from BabyShop - Total: $${invoiceData.order.totalAmount.toFixed(2)}`;
